...
sudo apt-get update
sudo apt-get remove --purge onboard gnomine aisleriot bluez gnome-orca gnome-accessibility-themes gnome-sudoku thunderbird ppp pptp-linux network-manager-pptp network-manager-pptp-gnome bluez-alsa brltty
